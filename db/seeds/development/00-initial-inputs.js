  ...
  return knex('users').del()
    .then(function () {
      ...
      knex('anna').insert([
        ...
        {id: 4, eventTitle: 'Check Email', startDate: '2021-07-05', startTime: '12:00', endDate:'2021-07-05', endTime:'13:00', type: 'task', location: 'office', availability: 'free', attendees: {}},
        {id: 5, eventTitle: 'Call Mom', startDate: '2021-07-07', startTime: '14:00', endDate:'2021-07-07', endTime:'14:30', type: 'task', location: 'office', availability: 'free', attendees: {}},
        {id: 6, eventTitle: 'Water plants', startDate: '2021-07-10', startTime: '16:30', endDate:'2027-07-10', endTime:'17:00', type: 'task', location: 'office', availability: 'busy', attendees: {}},
